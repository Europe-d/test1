fun main () {
  ...
  var eingegebenerDouble : Double = 20.8
  var eingegebenerInt : Int = 12
 ...
 println(ergebnisString)
     ...
     *
     */
        /*wenn wir to.double() geben bei int das rechnen normal aber wenn wir eine nummer mit komma haben und ist to.int()
        dann rechnen aber ohne das auf komma bei mir hier zu beispiel rechnen nicht diese .8
         */
